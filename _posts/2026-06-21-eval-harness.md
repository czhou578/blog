...
You can find the code in the `benchmarks` folder of my nanoGPT inference repository, [here.](https://github.com/czhou578/nanoGPT-inference/tree/main/benchmarks)
